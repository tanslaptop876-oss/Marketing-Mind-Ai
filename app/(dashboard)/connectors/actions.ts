...
export async function disconnectGa4(){const supabase=await createClient();await supabase.from("connector_accounts").delete().eq("provider","ga4");revalidatePath("/connectors")}
